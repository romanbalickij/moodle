...
/**
 * Strings for component 'badges', language 'uk', version '3.11'.
 *
 * @package     badges
 * @category    string
...
$string['backpackemailverifyemailbody'] = 'Привіт, За допомогою вашої адреси електронної пошти було надіслано запит на нове підключення до вашої торбинки з відзнаками. Щоб підтвердити та активувати підключення до вашої торбинки, перейдіть до {$a->sitename} У більшості поштових програм це повинно виглядати як синє посилання, на яке можна просто натиснути. Якщо це не спрацює, виріжте та вставте адресу у рядок адреси у верхній частині веб -переглядача. Якщо вам потрібна допомога, зверніться до адміністратора сайту, {$a->admin}';
