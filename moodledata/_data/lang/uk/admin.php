...
/**
 * Strings for component 'admin', language 'uk', version '3.11'.
 *
 * @package     admin
 * @category    string
...
$string['mypage'] = 'Типова Інформаційна панель';
...
$string['xmlrpcmaharaenabled'] = 'Було виявлено, що на вашому сайті ввімкнено електронне портфоліо Mahara. Ця функція спирається на розширення PHP XML-RPC, яке більше не підтримується PHP.';
$string['xmlrpcmnetenabled'] = 'Було виявлено, що на вашому сайті ввімкнено мережу Moodle. Ця функція спирається на розширення PHP XML-RPC, яке більше не підтримується PHP.';
