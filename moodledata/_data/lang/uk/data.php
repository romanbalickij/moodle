...
/**
 * Strings for component 'data', language 'uk', version '3.11'.
 *
 * @package     data
 * @category    string
...
$string['addtemplate'] = 'Шаблон редагування';
...
$string['authorfirstname'] = 'Ім’я автора';
$string['authorlastname'] = 'Прізвище автора';
...
$string['cannotdeletepreset'] = 'Помилка видалення представлення!';
...
$string['deletefield'] = 'Вилучити існуюче поле';
$string['deletenotenrolled'] = 'Вилучити записи не зареєстрованих користувачів';
$string['deletewarning'] = 'Ви впевнені, що хочете вилучити це представлення?';
...
$string['editorenable'] = 'Включити редактор';
...
$string['entrieslefttoadd'] = 'Вам потрібно додати більше чим {$a} записів перед тим, як ви зможете побачити записи інших учасників.';
...
$string['errorpresetexists'] = 'Вже існує представлення з такою назвою';
...
$string['failedpresetdelete'] = 'Помилка видалення представлення';
...
$string['fieldheightlistview'] = 'Висота в списку перегляду';
$string['fieldheightsingleview'] = 'Висота в одиничному перегляді';
$string['fieldids'] = 'Коди поля';
$string['fieldmappings'] = 'Структура полів';
...
$string['fieldwidthlistview'] = 'Ширина в списку перегляду';
$string['fieldwidthsingleview'] = 'Ширина в одиничному перегляді';
$string['file'] = 'Файл';
...
$string['foundnorecords'] = 'Не знайдено записів (<a href="{$a->reseturl}">Перевстановити фільтр</a>)';
$string['foundrecords'] = 'Знайдено записи: {$a->num}/{$a->max} (<a href="{$a->reseturl}">Перевстановити фільтр</a>)';
...
$string['header'] = 'Шапка';
$string['headeraddtemplate'] = 'Визначає інтерфейс для додавання або редагування записів';
$string['headerasearchtemplate'] = 'Визначає інтерфейс для розширеного пошуку';
$string['headercsstemplate'] = 'Визначте локальні CSS стилі для інших шаблонів';
$string['headerjstemplate'] = 'Визначає спеціальний Javascript для маніпулювання способом відображення елементів у шаблонах Список, Один або Додати';
$string['headerlisttemplate'] = 'Визначте інтерфейс перегляду для списку записів';
$string['headerrsstemplate'] = 'Визначте порядок записів у RSS новинах';
$string['headersingletemplate'] = 'Визначте інтерфейс перегляду для одного запису';
$string['importentries'] = 'Імпорт записів';
$string['importsuccess'] = 'Представлення було успішно застосоване.';
...
$string['manageapproved_help'] = 'Якщо відключено, то схвалені записи будуть недоступні для редагування або вилучення їх авторами. Ця опція не має сили при включеному параметрі "Потребує схвалення".';
...
$string['missingdata'] = 'Код даних або об’єкту повинні бути надані для класу поля';
...
$string['nolisttemplate'] = 'Список шаблонів ще не визначено';
$string['nomatch'] = 'Жодного запису не знайдено!';
$string['nomaximum'] = 'Максимум не визначено';
$string['norecords'] = 'Немає записів у базі даних';
$string['nosingletemplate'] = 'Одиночний шаблон ще не визначено';
...
$string['other'] = 'Інше';
$string['overrwritedesc'] = 'Переписати представлення, якщо воно вже існує';
$string['overwrite'] = 'Переписати';
$string['overwritesettings'] = 'Переписати поточні установки';
...
$string['privacy:metadata:data_content'] = 'Представляє одну відповідь на одне поле в модулі активності бази даних';
...
$string['privacy:metadata:data_records'] = 'Представляти записи в модулі активності бази даних';
...
$string['requireapproval_help'] = 'Якщо включено, то записи вимагатимуть погодження викладача перед тим, як бути доступними іншим студентам.';
...
$string['requiredentriestoview_help'] = 'Кількість записів, які студент повинен внести до бази даних, перед тим, як мати можливість бачити записи інших студентів. Зауваження: якщо вимагається внести записи перед переглядом інших, то фільтр авто-зв’язування записів бази даних буде автоматично відключено. Тому що за цим налаштуванням студент не повинен мати можливість перейти до інших записів, поки він не ввів свої.';
...
$string['saveaspreset'] = 'Зберегти як представлення';
...
$string['savesuccess'] = 'Збережено. Ваше представлення буде доступне для всього сайту.';
...
$string['wrongdataid'] = 'Надано неправильний код даних';
