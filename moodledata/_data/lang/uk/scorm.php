...
/**
 * Strings for component 'scorm', language 'uk', version '3.11'.
 *
 * @package     scorm
 * @category    string
...
$string['attemptstatusall'] = 'Інформаційна панель та сторінка входу';
$string['attemptstatusentry'] = 'Тільки сторінка входу';
$string['attemptstatusmy'] = 'Тільки Інформаційна панель';
