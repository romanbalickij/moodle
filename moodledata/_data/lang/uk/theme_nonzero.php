...
/**
 * Strings for component 'theme_nonzero', language 'uk', version '3.11'.
 *
...
<h2>Тема оформлення Nonzero</h2>
<img src="nonzero/pix/screenshot.png" />
...
<p>Nonzero - це нетрадиційна тема для Moodle з трьома колонками змінної ширини. Нетрадиційність її в тому, що що широка колонка, в які виводиться основний вміст, знаходиться ліворуч від обох колонок блоків.</p>
...
$string['configtitle'] = 'Тема Nonzero';
...
$string['regionpostwidth'] = 'Ширина правої колонки';
$string['regionpostwidthdesc'] = 'Задає ширину правої колонки, яка визначає зону для блоків.';
$string['regionprewidth'] = 'Ширина лівої колонки';
$string['regionprewidthdesc'] = 'Задає ширину лівої колонки, яка визначає зону для блоків. Ця колонка показується в середині сторінки.';
