...
/**
 * Strings for component 'theme_overlay', language 'uk', version '3.11'.
 *
...
<p>Overlay - це нетрадиційна тема для Moodle з трьома колонками змінної ширини. Нетрадиційність її в тому, що що широка колонка, в які виводиться основний вміст, знаходиться ліворуч від обох колонок блоків.</p>
...
$string['configtitle'] = 'Тема Overlay';
...
$string['headercolor'] = 'Колір заголовка';
$string['headercolordesc'] = 'Колір тла заголовка.';
