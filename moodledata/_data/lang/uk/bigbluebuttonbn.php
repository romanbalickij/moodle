...
/**
 * Strings for component 'bigbluebuttonbn', language 'uk', version '3.11'.
 *
...
$string['bbbrecordallfromstartwarning'] = 'Цей сеанс буде записано від початку.';
...
$string['completionattendance'] = 'Студент повинен бути присутній на зустрічі для:';
$string['completionattendance_desc'] = 'Студент повинен увійти до кімнати та залишитися на сесії принаймні {$a} хв.';
...
$string['completionengagement_desc'] = 'Студент повинен брати участь у діяльності під час зустрічі';
$string['completionengagementchats'] = 'Події чату';
$string['completionengagementchats_desc'] = 'Студент має взяти участь у чатах ({$a}), щоб завершити його.';
$string['completionengagementchats_event_desc'] = 'Створив {$a} чат(ів)';
$string['completionengagementemojis'] = 'Emojis';
$string['completionengagementemojis_desc'] = 'Щоб завершити опитування, студент має надіслати смайли ({$a}).';
$string['completionengagementemojis_event_desc'] = 'Підняв смайли: {$a}';
$string['completionengagementgroup'] = 'Вимагати участі';
...
$string['completionengagementpollvotes_desc'] = 'Щоб завершити опитування, студент повинен проголосувати в опитуваннях {$a} раз(ів).';
$string['completionengagementpollvotes_event_desc'] = 'Зібрав {$a} голосів у опитуванні';
$string['completionengagementraisehand'] = 'Події з підняттям руки';
$string['completionengagementraisehand_desc'] = 'Студент повинен підняти руку {$a} разів, щоб завершити його.';
$string['completionengagementraisehand_event_desc'] = 'Підняв руку {$a} разів';
$string['completionengagementtalks'] = 'Обговорення подій';
$string['completionengagementtalks_desc'] = 'Студент повинен поговорити {$a} раз(ів), щоб завершити його';
...
$string['completionview_event_desc'] = 'Переглянув сторінку кімнати.';
...
$string['config_disablecam_default'] = 'За замовченням камеру вимкнено';
$string['config_disablecam_default_description'] = 'Якщо відмічено, то камера буде вимкнена.';
$string['config_disablecam_editable'] = 'Вимкнення камери можна змінити';
...
$string['general_error_not_allowed_to_create_instances'] = 'Користувачу заборонено створювати будь-які типи.';
$string['general_error_not_found'] = 'Об’єкт не знайдено: {$a}.';
...
$string['instance_type_room_only'] = 'Кімната/діяльність без запису';
...
$string['mod_form_field_notification_msg_at'] = 'о';
...
$string['report_join_info'] = 'Приєднався до кімнати {$a} раз(ів)';
$string['report_play_recording_info'] = 'Відтворив запис {$a} раз(ів)';
$string['report_room_view'] = 'Переглянув кімнату';
