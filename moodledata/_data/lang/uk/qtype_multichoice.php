...
/**
 * Strings for component 'qtype_multichoice', language 'uk', version '3.11'.
 *
...
$string['showstandardinstruction_help'] = 'Показувати інструкції "Виберіть один:" або "Виберіть один або кілька:" перед відповідями з кількома варіантами.';
