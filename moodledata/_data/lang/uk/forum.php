...
/**
 * Strings for component 'forum', language 'uk', version '3.11'.
 *
 * @package     forum
 * @category    string
...
$string['postisprivatereply'] = 'Це приватна відповідь. Його бачать лише ви та всі, хто має можливість переглядати приватні відповіді, наприклад викладачі чи менеджери.';
